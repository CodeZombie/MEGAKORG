...
String index_html = "<html> <head> <style>table, td{border-style: solid; border-width: 1px; border-color: black;}</style> <script>function turnBank(){var e=prompt('Enter a value (0-22):','4');if(null!=e){var t=new XMLHttpRequest;t.onreadystatechange=function(){4==this.readyState&&(console.log('Request returned with code '+this.status),document.getElementById('bankKnob').innerText='EDIT SELECT ('+this.response+')')},t.open('GET','/turnBank?value='+e,!0),t.send()}}function turnKnob(e){var t=prompt('Enter a value (0-255):','64');if(null!=t){var n=new XMLHttpRequest;n.onreadystatechange=function(){4==this.readyState&&(console.log('Request returned with code '+this.status),document.getElementById('knobButton_'+e).innerText='KNOB '+e+'('+this.response+')')},n.open('GET','/turnKnob?knob='+e+'&value='+t,!0),n.send()}}</script> </head> <body> <table> <tbody> <tr> <td></td><td><a id='knobButton_0' href='javascript:turnKnob(0);'>KNOB 0 (0)</a></td><td><a id='knobButton_1' href='javascript:turnKnob(1);'>KNOB 1 (0)</a></td><td><a id='knobButton_2' href='javascript:turnKnob(2);'>KNOB 2 (0)</a></td><td><a id='knobButton_3' href='javascript:turnKnob(3);'>KNOB 3 (0)</a></td><td><a id='knobButton_4' href='javascript:turnKnob(4);'>KNOB 4 (0)</a></td></tr><tr> <td><a id='bankKnob' href='javascript:turnBank();'>EDIT SELECT (0)</a></td></tr></tbody> </table> </body></html>";
